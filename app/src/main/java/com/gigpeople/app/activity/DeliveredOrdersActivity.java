...
import com.gigpeople.app.adapter.SaleThreeAdapter;
...
public class DeliveredOrdersActivity extends AppCompatActivity {
    ...
    Dialog share, rating, reviewdialog, deliverydialog;
    ...
    @BindView(R.id.btn_delivery_satisfied)
    Button btnDeliverySatisfied;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myorders_delivered_details);
        ButterKnife.bind(this);
        //adapterImageSlide = new AdapterImageSlide(DeliveredOrdersActivity.this, banner);
        viewpager.setAdapter(adapterImageSlide);
        pageController.setViewPager(viewpager);
        Window window = DeliveredOrdersActivity.this.getWindow();

        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.setStatusBarColor(ContextCompat.getColor(DeliveredOrdersActivity.this, R.color.colorPrimaryDark));
        }
        try {
        ...
        //salesReviewAdapter = new SalesReviewAdapter(DeliveredOrdersActivity.this);
        recyclerReview.setAdapter(salesReviewAdapter);
        recyclerReview.setLayoutManager(new LinearLayoutManager(DeliveredOrdersActivity.this));
        ...
        sale_list.add(new ChatModel("","Me"));
        adapter1 = new SaleThreeAdapter(DeliveredOrdersActivity.this, sale_list);
        ...
        if(getIntent()!=null)
        {
            ...
            {
                btnDeliverySatisfied.setVisibility(View.GONE);
            }
            else
            {
                btnDeliverySatisfied.setVisibility(View.VISIBLE);
    ...
    @OnClick({R.id.btn_back_arrow, R.id.btn_menu, R.id.img_fav, R.id.userImage, R.id.btn_rate, R.id.review, R.id.revision, R.id.message, R.id.cancel, R.id.btn_delivery_satisfied, R.id.img_chat, R.id.img_share, R.id.workhistory_layout, R.id.review_layout})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_fav:
                ...
                break;
            case R.id.userImage:
                Intent intent1 = new Intent(DeliveredOrdersActivity.this, ReviewListActivity.class);
            ...
            case R.id.message:
                ...
                Intent intent2 = new Intent(DeliveredOrdersActivity.this, MessengerActivity.class);
            ...
            case R.id.cancel:
                ...
                Intent intent3 = new Intent(DeliveredOrdersActivity.this, MainActivity.class);
                intent3.putExtra("page", "1");
                startActivity(intent3);

                break;

            case R.id.btn_delivery_satisfied:
            ...
            case R.id.img_chat:
                ...
                Intent intent4 = new Intent(DeliveredOrdersActivity.this, ChatDetailsActivity.class);
    ...
    private void openmessagedialog() {
        messagedialog = new Dialog(DeliveredOrdersActivity.this);
    ...
    private void opendeliverydialog() {
        deliverydialog = new Dialog(DeliveredOrdersActivity.this);
        deliverydialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        deliverydialog.setContentView(R.layout.dialog_delivery_satisfied);
        deliverydialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        deliverydialog.show();
        Button yes = (Button) deliverydialog.findViewById(R.id.btn_yes);
        Button no = (Button) deliverydialog.findViewById(R.id.btn_no);
    ...
    private void openrevisiondialog() {
        ...
        reviewdialog = new Dialog(DeliveredOrdersActivity.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(DeliveredOrdersActivity.this, MainActivity.class);
                intent1.putExtra("page", "1");
                startActivity(intent1);
            }
        });
    ...
    private void openratingdialog() {
        rating = new Dialog(DeliveredOrdersActivity.this);
    ...
    private void openratingdialog2() {
        rating = new Dialog(DeliveredOrdersActivity.this);
        rating.requestWindowFeature(Window.FEATURE_NO_TITLE);
        rating.setContentView(R.layout.dialog_rating);
        rating.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    private void opensharedialog() {
        ...
        share = new Dialog(DeliveredOrdersActivity.this);
        ...
        share1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* Intent share = new Intent(DeliveredOrdersActivity.this, ShareActivity.class);
                startActivity(share);*/
            }
        });
        ...
        chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DeliveredOrdersActivity.this, ChatDetailsActivity.class);
