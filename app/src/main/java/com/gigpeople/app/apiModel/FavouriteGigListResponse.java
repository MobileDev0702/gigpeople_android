...
public class FavouriteGigListResponse {
    ...
    @SerializedName("favouritegig_list")
    @Expose
    private List<FavouritegigList> favouritegigList = null;
    ...
    public List<FavouritegigList> getFavouritegigList() {
        return favouritegigList;
    }

    public void setFavouritegigList(List<FavouritegigList> favouritegigList) {
        this.favouritegigList = favouritegigList;
    }

    public class FavouritegigList {
