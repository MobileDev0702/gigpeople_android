...
public class MySalesListResponse {
    ...
    @SerializedName("total_eaarning")
    @Expose
    public String totalEaarning;
    @SerializedName("revenue_of_month")
    @Expose
    public String revenueOfMonth;
    @SerializedName("order_request_list")
    @Expose
    public List<OrderRequestList> orderRequestList = null;
    @SerializedName("current_order_list")
    @Expose
    public List<CurrentOrderList> currentOrderList = null;
    @SerializedName("completed_order_list")
    @Expose
    public List<CompletedOrderList> completedOrderList = null;
    @SerializedName("cancelled_order_list")
    @Expose
    public List<CancelledOrderList> cancelledOrderList = null;
    ...
    public String getTotalEaarning() {
        return totalEaarning;
    }

    public void setTotalEaarning(String totalEaarning) {
        this.totalEaarning = totalEaarning;
    }
    ...
    public void setRevenueOfMonth(String revenueOfMonth) {
    ...
    public List<CurrentOrderList> getCurrentOrderList() {
        return currentOrderList;
    }

    public void setCurrentOrderList(List<CurrentOrderList> currentOrderList) {
        this.currentOrderList = currentOrderList;
    }

    public List<CompletedOrderList> getCompletedOrderList() {
        return completedOrderList;
    }

    public void setCompletedOrderList(List<CompletedOrderList> completedOrderList) {
    ...
    public void setCancelledOrderList(List<CancelledOrderList> cancelledOrderList) {
