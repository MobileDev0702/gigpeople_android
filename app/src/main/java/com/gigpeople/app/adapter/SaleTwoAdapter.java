...
public class SaleTwoAdapter extends RecyclerView.Adapter<SaleTwoAdapter.DataObjectHolder> {
    ...
    public SaleTwoAdapter(Context context, List<ChatModel> chat_list) {
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_mysale_orders_two, parent, false);
