...
public class MyGigActiveAdapter extends RecyclerView.Adapter<MyGigActiveAdapter.DataObjectHolder> {

    Context context;
    List<GiGListResponse.PublishGigList> mData=new ArrayList<>();
    String types;
    ...
    public MyGigActiveAdapter(Context context, List<GiGListResponse.PublishGigList> mData) {
