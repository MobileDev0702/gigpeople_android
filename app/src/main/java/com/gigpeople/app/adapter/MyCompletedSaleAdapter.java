...
public class MyCompletedSaleAdapter extends RecyclerView.Adapter<MyCompletedSaleAdapter.DataObjectHolder> {


    Context context;
    List<MySalesListResponse.CompletedOrderList> mData;
    String types;
    ...
    public MyCompletedSaleAdapter(Context context,List<MySalesListResponse.CompletedOrderList> mData) {
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_mysale_completeditem, parent, false);
    ...
    public void onBindViewHolder(final DataObjectHolder holder, final int position) {
        ...
        if (mData.get(position).getBuyerDetails().getRating() != null) {
            holder.ratingbar.setRating(Float.parseFloat(mData.get(position).getBuyerDetails().getRating()));
        }
