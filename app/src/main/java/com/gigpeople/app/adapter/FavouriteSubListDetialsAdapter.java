...
public class FavouriteSubListDetialsAdapter extends RecyclerView.Adapter<HomeUserSubCategoryAdapter.DataObjectHolder> {


    Context context;
    List<TempNameAndIMageUrlModel> mData;
    String types;
    ...
    public FavouriteSubListDetialsAdapter(Context context, List<TempNameAndIMageUrlModel> mData) {
    ...
    @Override
    public HomeUserSubCategoryAdapter.DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_user_subcategory, parent, false);

        HomeUserSubCategoryAdapter.DataObjectHolder dataObjectHolder = new HomeUserSubCategoryAdapter.DataObjectHolder(view);

        return dataObjectHolder;
    }

    @Override
    public void onBindViewHolder(final HomeUserSubCategoryAdapter.DataObjectHolder holder, final int position) {
