...
public class ReviewListAdapter extends RecyclerView.Adapter<ReviewListAdapter.DataObjectHolder> {


    Context context;
    List<MoreReviewResponse.BuyerReview> mData;
    String types;
    ...
    public ReviewListAdapter(Context context,List<MoreReviewResponse.BuyerReview> mData) {
