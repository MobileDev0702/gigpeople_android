...
import com.gigpeople.app.activity.MysaleItemActivity;
...
public class MysaleAdapter extends RecyclerView.Adapter<MysaleAdapter.DataObjectHolder> {

    Context context;
    List<MySalesListResponse.CurrentOrderList> mData;
    String types;
    ...
    public MysaleAdapter(Context context,List<MySalesListResponse.CurrentOrderList> mData) {
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_mysale_item, parent, false);
