...
public class DeliveredOrderedAdapter extends RecyclerView.Adapter<DeliveredOrderedAdapter.DataObjectHolder> {

    Context context;
    ItemClickListener itemClickListener;

    List<MyOrdersDetailResponse.OrderDelivery> mData;

    public interface ItemClickListener {
        void itemClick(String name, int position, String makeid);
    }

    public DeliveredOrderedAdapter(Context context, List<MyOrdersDetailResponse.OrderDelivery> mData) {
