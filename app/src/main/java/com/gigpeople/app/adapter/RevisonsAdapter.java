...
public class RevisonsAdapter extends RecyclerView.Adapter<RevisonsAdapter.DataObjectHolder> {


    Context context;
    List<RevisonsModel> mData;
    ...
    public RevisonsAdapter(Context context, List<RevisonsModel> mData, ItemClickListener itemClickListener) {
