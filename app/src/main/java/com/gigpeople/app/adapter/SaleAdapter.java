...
public class SaleAdapter extends RecyclerView.Adapter<SaleAdapter.DataObjectHolder> {


    Context context;
    List<MyOrdersDetailResponse.MessageList> chat_list;
    ...
    public SaleAdapter(Context context, List<MyOrdersDetailResponse.MessageList> chat_list) {
