...
public class BuyerRequestAdapter extends RecyclerView.Adapter<BuyerRequestAdapter.DataObjectHolder> {

    Context context;
    List<GigRequestResponse.RequestDetail> mData;
    String types;
    ...
    public BuyerRequestAdapter(Context context, List<GigRequestResponse.RequestDetail> mData) {
