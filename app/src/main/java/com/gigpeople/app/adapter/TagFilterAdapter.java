...
public class TagFilterAdapter extends RecyclerView.Adapter<TagFilterAdapter.DataObjectHolder> {
    ...
    public TagFilterAdapter(Context context, List<InnerLanguageTagModel> mData) {
